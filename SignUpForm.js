        ...
        <>
            {formSubmit ? (
                <>
                    <SignInForm />
                    <span></span>
                    <h4 className="sucesss">Enregistrement réussi, veuillez vous connecter </h4>
                </>
            ):(
                ...
                <form action="" onSubmit={handleRegister} id="sign-up-form">
                    ...
                    <label htmlFor="controlPassword">Confirmer votre mot de passe</label>
                    <br />
                    <input type="password" name="password" id="controlPassword" onChange={(e) => setControlPassword(e.target.value)} />
